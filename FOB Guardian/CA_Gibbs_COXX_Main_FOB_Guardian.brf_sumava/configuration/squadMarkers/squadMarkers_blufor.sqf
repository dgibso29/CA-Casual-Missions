...
SET_SQUAD_ICON(COMMAND,ICON_HQ);

SET_SQUAD_IMPORTANT(HAMMER,true);
SET_SQUAD_COLOUR(HAMMER,true,COLOUR_CYAN);
SET_SQUAD_ICON(HAMMER,ICON_ARMOR);

SET_SQUAD_IMPORTANT(ANVIL,true);
SET_SQUAD_COLOUR(ANVIL,COLOUR_MAGENTA);
SET_SQUAD_ICON(ANVIL,ICON_ARMOR);

SET_SQUAD_IMPORTANT(BLACK WIDOW,true);
SET_SQUAD_COLOUR(BLACK WIDOW,true,COLOUR_CYAN);
SET_SQUAD_ICON(BLACK WIDOW,ICON_HELO);

SET_SQUAD_IMPORTANT(PHANTOM,true);
SET_SQUAD_COLOUR(PHANTOM,COLOUR_MAGENTA);
SET_SQUAD_ICON(PHANTOM,ICON_HELO);

SET_SQUAD_IMPORTANT(REAPER,true);
SET_SQUAD_COLOUR(REAPER,true,COLOUR_CYAN);
SET_SQUAD_ICON(REAPER,ICON_HELO);

SET_SQUAD_IMPORTANT(SCYTHE,true);
SET_SQUAD_COLOUR(SCYTHE,COLOUR_MAGENTA);
SET_SQUAD_ICON(SCYTHE,ICON_HELO);

_group = GET_SQUAD_ON_SIDE(GUARDIAN,west);
SET_SQUAD_IMPORTANT_DIRECT(_group,true);
HIDE_SQUAD_DIRECT(_group);

_group = GET_SQUAD_ON_SIDE(MINUTEMAN,west);
SET_SQUAD_IMPORTANT_DIRECT(_group,true);
HIDE_SQUAD_DIRECT(_group);

_group = GET_SQUAD_ON_SIDE(SLEDGE 1-1,west);
SET_SQUAD_IMPORTANT_DIRECT(_group,true);
HIDE_SQUAD_DIRECT(_group);

_group = GET_SQUAD_ON_SIDE(SLEDGE 1-2,west);
SET_SQUAD_IMPORTANT_DIRECT(_group,true);
HIDE_SQUAD_DIRECT(_group);

_group = GET_SQUAD_ON_SIDE(SLEDGE 1-3,west);
SET_SQUAD_IMPORTANT_DIRECT(_group,true);
HIDE_SQUAD_DIRECT(_group);
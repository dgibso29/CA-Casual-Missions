...
[_longRadio, "GROUND NET", west, ["sl", "ftl", "co", "med", "fac", "crew"]] call f_fnc_acre_giveRadioToAllInRole;

[_backpackRadio, "AIR NET", west, ["fac", "zeus", "pilot"]] call f_fnc_acre_giveRadioToAllInRole;

[_backpackRadio, "GROUND NET", west, "zeus"] call f_fnc_acre_giveRadioToAllInRole;

...
KPLIB_b_allSquads = [
    ...
    [german_squad_inf_light,200,0,0],
    [german_squad_inf,300,0,0],
    [german_squad_at,200,250,0],
    [german_squad_aa,200,250,0],
    [german_squad_recon,250,0,0],
    [german_squad_para,200,0,0],
    [british_squad_inf_light,200,0,0],
    [british_squad_inf,300,0,0],
    [british_squad_at,200,250,0],
    [british_squad_aa,200,250,0],
    [british_squad_recon,250,0,0],
    [british_squad_para,200,0,0]
];
...
squads_names = [
    ...
    localize "STR_GER_LIGHT_RIFLE_SQUAD",
    localize "STR_GER_RIFLE_SQUAD",
    localize "STR_GER_AT_SQUAD",
    localize "STR_GER_AA_SQUAD",
    localize "STR_GER_RECON_SQUAD",
    localize "STR_GER_PARA_SQUAD",
    localize "STR_UK_LIGHT_RIFLE_SQUAD",
    localize "STR_UK_RIFLE_SQUAD",
    localize "STR_UK_AT_SQUAD",
    localize "STR_UK_AA_SQUAD",
    localize "STR_UK_RECON_SQUAD",
    localize "STR_UK_PARA_SQUAD"  
];
